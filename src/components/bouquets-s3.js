...
class BouquetsS3 extends Component{
    render(){
        return(    
            <Container fluid className="bouquets-s3 d-flex minh-50vh align-items-center py-5 bg-secondary border-top border-dark">
